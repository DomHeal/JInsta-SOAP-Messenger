...
public class AdminGUI extends JDialog {
	...
	private ImageIcon adminIcon = new ImageIcon(getClass().getClassLoader().getResource("images/adminIcon.png"));
	private ImageIcon admin_enabled = new ImageIcon(getClass().getClassLoader().getResource("images/admin_enabled.png"));
	private ImageIcon admin_disabled = new ImageIcon(getClass().getClassLoader().getResource("images/admin_enabled.png"));
	private Image icon = new ImageIcon(getClass().getClassLoader().getResource("images/icon.png")).getImage();
